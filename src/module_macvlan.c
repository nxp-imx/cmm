...
*
*****************************************************************/
int cmmFeMacVlanUpdate(cpal_handle_t *cpal_handle, int fd, int request,
...
#ifndef DPDK_ENABLE
		ret = cpal_write(cpal_handle, FPP_CMD_MACVLAN_ENTRY, sizeof(fpp_macvlan_cmd_t), (unsigned short *) &cmd);
