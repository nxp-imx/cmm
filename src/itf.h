...
#ifndef SAM_LEGACY
#ifndef RTM_NEW4RD
#define RTM_NEW4RD 97 /* If RTM_NEW4RD is not defined we can safely assume that RTM_DEL4RD and RTM_GET4RD will also not be defined */
...
struct interface_table {
	...
	cpal_handle_t *cpal_handle;
	cpal_handle_t *cpal_key_handle;
};
